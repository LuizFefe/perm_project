...
document.getElementById("search").addEventListener("keydown", function (e) {
  ...
  document.getElementById("dam").classList.remove("ativo");
});
...
document.getElementById("dam").addEventListener("click", function (e) {
  if (document.getElementById("searchh").value == "Aguardando o envio da DAM") {
    document.getElementById("searchh").value = "";
    $("input#searchh").keyup();
    document.getElementById("dam").classList.remove("ativo");
  } else {
    ...
    document.getElementById("rever").classList.remove("ativo");
    document.getElementById("aprovado").classList.remove("ativo");
    document.getElementById("dam").classList.add("ativo");
    document.getElementById("searchh").value = "Aguardando o envio da DAM";
    $("input#searchh").keyup();
  }
});
function openNav() {
