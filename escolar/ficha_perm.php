...
if (($resultado_02_count != 0)) {
    ...
    while ($row = $resultado_02->fetch()) {
        ...
        $colegio_localdeponto = $row['colegio_localdeponto'];
        ...
        $multas = $row['multas'];
        $multasstatus = $row['multasstatus'];

        $cnh = $row['cnh'];
        $cnhstatus = $row['cnh_status'];

        $cert_mun = $row['cert_mun'];
        $certmunstatus = $row['certmun_status'];

        $certpenal = $row['certpenal'];
        $certpenalstatus = $row['certpenal_status'];

        $atestadosanidade = $row['atestadosanidade'];
        $atestadosanidadestatus = $row['atestado_sanidade_status'];

        $inss = $row['negativainss'];
        $inssstatus = $row['negativainssstatus'];

        $residencia = $row['residencia'];
        $residenciastatus = $row['residencia_status'];

        $cursodecondutor = $row['cursodecondutor'];
        $cursodecondutorstatus = $row['curso_status'];
            ...
            <div id="container">
                ...
                <main>
                    ...
                    <fieldset id="cadastro_contratantes" class="div-show" style="display: block;padding-bottom:50px;margin-bottom:100px">
                        ...
                        <br>Nº do Autorizado: <b><?php echo $nperm; ?></b>
                        <br>Colegio/Local do Ponto: <b><?php echo $colegio_localdeponto; ?></b>
                        <br>Iitinerário: <b><?php echo $itinerario; ?></b>
                        <br>Tipo de Cadastro: <b><?php echo $tipo; ?></b>
                        <?php if ($status == 2 || $status == 3) {
                        ?><br><br><br><strong style="">NOTA DE PENDENCIA:</strong> <b><?php echo $nota; ?></b><br>
                            <div id="documents"> <?php if ($cnhstatus == 2) {
                                    ...
                                    <div style="display:flex;align-items:center;justify-content:center;"><button style="border:0" type="button" data-toggle="collapse" data-target="#inssshow" aria-expanded="false" aria-controls="inssshow">Mostrar Documento</button></div> <b><?php echo '<div class="collapse" id="inssshow">
                                                    <div class="card card-body" style="border:0">
                                                    <iframe src="../public/docs_escolar/' . $inss . '" width="95%" height="500px"> </iframe>
                                                    </div>
                                                    </div>'; ?></b><br> <?php }
                                                                    if ($alvarastatus == 2) {
                                    ...
                                    <div style="display:flex;align-items:center;justify-content:center;"><button style="border:0" type="button" data-toggle="collapse" data-target="#multashow" aria-expanded="false" aria-controls="quitacaoshow">Mostrar Documento</button></div> <b><?php echo '<div class="collapse" id="multashow">
                                                    <div class="card card-body" style="border:0">
                                                    <iframe src="../public/docs_escolar/' . $multas . '" width="95%" height="500px"> </iframe>
                                                    </div>
                                                    </div>'; ?></b><br> <?php }
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="margin-left:20px">
                        ...
                        <form method="post" id="formreenvio" autocomplete="off" action="../src/escolar/resenddocumtospendentespermesc.php" enctype='multipart/form-data'>
                            <div class="form-row">
                                <?php if ($status == 2) {
                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                    ?><br><strong style="">NEGATIVA DE MULTAS PENDENTE:</strong><br><input type="file" class="form-control-file" id="exampleFormControlFile1" name="multas" required> <b><?php /* echo '<iframe src="../public/docs_motorista/' . $cert_mun . '" width="90%" height="500px"> </iframe>' */; ?></b><br> <?php }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    if ($cnhstatus == 2) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ?><br><strong style="">CNH PENDENTE:</strong><br><input type="file" class="form-control-file" id="exampleFormControlFile1" name="CNHP" required> <b><?php /* echo '<iframe src="../public/docs_motorista/' . $certpenal . '" width="90%" height="500px"> </iframe>';  */ ?></b><br> <?php }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        if ($certmunstatus == 2) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ?><br><strong style="">NEGATIVA MUNICIPAL PENDENTE:</strong><br><input type="file" class="form-control-file" id="exampleFormControlFile1" name="negmunpj" required> <b><?php /* echo '<iframe src="../public/docs_motorista/' . $atestadosanidade . '" width="90%" height="500px"> </iframe>'; */ ?></b><br> <?php }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        if ($certpenalstatus == 2) {
        ...
        <div id="documents">
            ...
            <?php } elseif ($tipo == 'MEI') { ?>
                <div id="documents">
                    ...
                    <div style="display:flex;align-items:center;justify-content:center;"><button style="border:0" type="button" data-toggle="collapse" data-target="#multashoww" aria-expanded="false" aria-controls="quitacaoshow">Mostrar Documento</button></div> <b><?php echo '<div class="collapse" id="multashoww">
                                                    <div class="card card-body" style="border:0">
                                                    <iframe src="../public/docs_escolar/' . $contratosocial . '" width="95%" height="500px"> </iframe>
                                                    </div>
                                                    </div>'; ?></b><br> <?php } ?>
