                        ...
                        <div>
                            ...
                            <div class="justify-content-between h5 mt-5 mb-5 font-weight-bold" style="<?php echo $infostyle ?>" id="containterinfo">
                                <div>
                                    ...
                                    <b class="text-muted">Colégio/Local de Ponto: </b><?php echo $colegiolocalponto; ?><br>
                                    <b class="text-muted">Itinerário: </b><?php echo $itinerario; ?><br>
                                    ...
                                    <form action="../src/partegestao/aprovacomissaoescolar.php" method="POST">
                                        ...
                                        <?php if ($nivelacesso == 15) { ?>
                                            ...
                                            <div style="display:flex;flex-direction:column">
                                                ...
                                                <label for="cmcperm" class="doccumenteditable">Colégio/Local do Ponto</label>
                                ...
                                <div class="modal-body">
                                    <form action="../src/partegestao/pendenciapermescolar.php" method="POST">
                                        <div id="documentsform">
                                            <div style="text-align:center"> <label for="cnh"><input id="cnh" name="alvara" type="checkbox" value="1" /><strong>ALVARÁ</strong></label></div>
                    ...
                    <div class="containerborder" role="main">
                        ...
                        if ($stat == 0 && $nivelacesso > 1 ||  $stat == 3 && $nivelacesso > 1) {
                            ...
                            if ($tipoescolar == 'CPF') { ?>
                                ...
                                <div class=" text-center m-3">
                                    <div>
                                        <button class="d-block p-2 btn btn-warning w-100" data-toggle="modal" data-target="#PENDENTEpf" role="button" id="buttoncontrol" style="font-size:33px"><i class="uil uil-file-times-alt"></i> Documentação Pendente</button>
                                    </div>
                                </div>
                            <?php } ?>
                            <!-- ---------------------------- BOTAO PARA APROVAR MOTORISTA ---------------------------- -->
