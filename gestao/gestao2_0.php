...
<body>
    <form id="qsform">
        <input type="text" id="searchh" hidden>
    </form>
    <div id="mySidebar" class="sidebar">
        ...
        <a href="#" class="sidebaritem" id="dam">Aguardando o Envio da DAM</a>
    </div>

    <div id="main">
        <div>
            <nav class="navbar navbar-default" style="background-color: #003466;">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <div>
                        <button class="p-2 btn btn-primary m-3" data-toggle="modal" data-target="#MODAL_ACOES" style="white-space: nowrap">Minhas Ações</button>
                        <a class="p-2 btn btn-primary m-3" href="../login/sairgestao.php">Sair</a>
                    </div>
                </ul>
            </nav>
        </div>
        ...
        <!-- <div class="d-flex justify-content-center mt-5" hidden>
            <form hidden>
                <input type="text" id="search" placeholder="BUSCAR" hidden>
            </form>
        </div> -->
        <div id="taxistas">
            <?php
            ...
            <?php
                ...
                echo '<div style="text-align: -webkit-center;"><table width="80%" id="divveiculo">
                        <caption class="text-center font-weight-bolder" style="caption-side:top;font-size:40px;font-weight:bolder;color:black">VEICULOS TAXISTAS</caption>
                        <thead>
                        <tr style="background-color: #f8d7da;border-color: #f5c6cb;position: relative;padding: 0.75rem 1.25rem;margin-bottom: 1rem;border: 2px solid #f5c6cb;border-radius: 0.25rem;height: 50px;">
    ...
    <script src="../public/scripts/gestaoteste.js"></script>
</body>
