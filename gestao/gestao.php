        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="MODAL_ficha">Ações do gestor no Site</h5>
    ...
    <div class="container" role="main">
        ...
        <div role="group" style="margin-block-end: 1em;text-align:center">
            <div class="m-3" id="firstselect">
                <button class="btn btn-lg m-3 btn-success" id="taxista" onclick="selecttaxista()">Ver Taxistas <br> Pendências: <?php echo $pendenciataxista ?> </button>
                <button class="btn btn-lg m-3 btn-success" id="escolar" onclick="selectescolares()">Ver Escolares <br> Pendências: <?php echo $pendenciasescolar ?> </button>
            </div>
            <!-- <div class="m-3 d-none" id="taxistabuttons">
                <button class="btn btn-lg m-3 btn-success" id="permissionariotaxi" onclick="selectpermissionario()">Ver Permissionários Taxistas <br> Pendências: <?php echo $resultado_mottaxiperm_count ?></button>
                <button class="btn btn-lg m-3 btn-success" id="auxiliartaxi" onclick="selectauxiliar()">Ver Auxiliares Taxistas <br> Pendências: <?php echo $resultado_mottaxiauxperm_count ?></button>
                <button class="btn btn-lg m-3 btn-success" id="veiculostaxi" onclick="selectveiculo()">Ver Veículos Taxistas <br> Pendências: <?php echo $resultado_permtaxi_count ?></button>
            </div>
            <div class="m-3 d-none" id="escolarbuttons">
                <button class="btn btn-lg m-3 btn-success" id="permissionarioescolar" onclick="permescolar()">Ver Permissionários Escolares <br> Pendências: <?php echo $resultado_perm_count ?></button>
                <button class="btn btn-lg m-3 btn-success" id="auxiliarescolar" onclick="motmoniescolarr()">Ver Motoristas/Monitores <br> Pendências: <?php echo $resultado_motmoni_count ?></button>
                <button class="btn btn-lg m-3 btn-success" id="veiculosescolar" onclick="veiculoescolar()">Ver Veículos Escolares <br> Pendências: <?php echo $resultado_veicesc_count ?></button>
            </div> -->
        </div>
    ...
    <div id="taxistas">
                        ...
                        <tr>
                            ...
                            <td width=10% style="text-align:center">
                                ...
                                <?php  } elseif (($stat == '2' && $statcomissao != '1') && ($stat == '2' && $statcomissao != '2') && ($stat == '2' && $statcomissao != '3')) {
                                        $status = "Pendente de<br>Documentação";
                                ...
                                <?php  } elseif (($stat == '3' && $statcomissao != '1') && ($stat == '3' && $statcomissao != '2') && ($stat == '3' && $statcomissao != '3')) {
                                        $status = "Aguardando a<br>Reanálise"; ?>
                                    <div style="background-color:#f0ad4e;border-radius:15px"><a><?php echo $status ?></a></div>
                                ...
                                <?php  } elseif ($statcomissao == '0' || $statcomissao == '1' || $statcomissao == '2') {
                                        $status = 'Aguardando aprovação da comissão ' . $statcomissao . '/3'; ?>
                                    <div style="background-color:#0275d8;border-radius:15px"><a><?php echo $status ?></a></div>
                                <?php } ?>
        ...
        <?php
            ...
            <tr style="background-color: #f8d7da;border-color: #f5c6cb;position: relative;padding: 0.75rem 1.25rem;margin-bottom: 1rem;border: 2px solid #f5c6cb;border-radius: 0.25rem;height: 50px;">
                <th style="    text-align: center;"><b><a class="text-default">Nenhum permissionário taxista encontrado!<br></a></b></th>
            </tr>
            </thead>
      </table></div>
';
    ...
    <div id="escolares"> <?php
            ...
            <div class="container" theme-showcase" role="main" id="divpermescolar">
                ...
                <table id="dtBasicExample5" class="tablesorter-blue sortable lista-clientes table table-striped table-hover table-sm" cellspacing="0" width="100%">
                    <caption class="text-center font-weight-bolder" style="caption-side:top;font-size:40px;font-weight:bolder;color:black">PERMISSIONÁRIOS ESCOLARES</caption>
                    <thead>
                        <tr class="tablesorter-headerRow table-primary">
                            <th><b><a class="text-default">Nº Ordem</a></b></th>
                            <th><b><a class="text-default">Nome</th>
...
';
            ...
            if (($resultado_03_count != 0)) { ?>
                <div class="container" theme-showcase" role="main" id="divveiculo">
                    <!-- <p class="text-center font-weight-bolder">VEÍCULOS TAXISTAS</p> -->
                    <table id="dtBasicExample3" class="tablesorter-blue sortable lista-clientes table table-striped table-hover table-sm" cellspacing="0" width="100%">
                        <caption class="text-center font-weight-bolder" style="caption-side:top;font-size:40px;font-weight:bolder;color:black">VEÍCULOS TURISMO</caption>
                        <thead>
                            <tr class="table-primary">
                                <th style="width:5%"><b><a class="text-default">ID Veiculo<br></a></b></th>
                                <th><b><a class="text-default">Placa<br></th>
