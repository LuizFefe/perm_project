...
$query_04 = "SELECT * FROM permissionarios.veiculoescolar WHERE doc_permissionario = '$documento' ";
var_dump($query_04);
        ...
        <table style="overflow-x: auto;white-space: nowrap;font-family:montserrat;page-break-inside:avoid;border:1px solid black;border-collapse: collapse;font-size:15px;width:100%" >
            ...
            <tr>
                <td colspan="6" scope="colgroup" style="text-align: center;vertical-align: middle;background-color:#dbdbdb">
                    <div style="text-align:center"><strong>LICENÇA DE TRÁFEGO</strong></div>
                </td>
            </tr>
            <tr>
            ...
            <tr >
                <td colspan="6" scope="colgroup" style="text-align: center;vertical-align: middle;background-color:#fff;font-size:12px"><strong>VEÍCULO AUTORIZADO PARA REALIZAR O SERVIÇO DE TRANSPORTE TURÍSTICO NO MUNICIPIO DE FLORIANÓPOLIS</td>
            </tr>
