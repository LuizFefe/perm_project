...
if (($resultado_04_count != 0)) {
  while ($row = $resultado_04->fetch()) {
    ...
    $diavistoria = date("d-m-Y", strtotime("-6 months", strtotime($newDate)));
    $placa = $row['placa'];
    $renavam = $row['renavam'];
    $lotacao = $row['lotacao'];
...
$documentacao = ' 
        ...
        <td colspan="5" scope="colgroup" style="text-align: right;font-family:montserrat;font-size:11px;border:0" >PREFEITURA MUNICIPAL DE FLORIANÓPOLIS<br>SECRETARIA MUNICIPAL DE MOBILIDADE E PLANEJAMENTO URBANO<br>DIRETORIA DE PLANEJAMENTO E FISCALIZAÇÃO DE TRANSPORTE</td>
            ...
            <tr>
                <td colspan="1" scope="colgroup" style="text-align: left;vertical-align: middle;background-color:#fff">SERVIÇO: <strong>TAXI</strong></td>
                <td width="40%" colspan="3" scope="colgroup" style="text-align: left;vertical-align: middle;background-color:#fff"><strong>EMITIDO EM : </strong>' . $newDate . '</td>
                <td width="40%" colspan="2" scope="colgroup" style="text-align: left;vertical-align: middle;background-color:#fff"><strong>VALIDO ATÉ : </strong>' . $vigselo . '</td>
            </tr>
            <tr height="10%">
                <td colspan="6" scope="colgroup" style="text-align: left;vertical-align: middle;background-color:#fff"><strong>NOME : </strong>' . $nome . '</td>

            </tr>
            <tr>
            <td  colspan="3" scope="colgroup" style="text-align: left;vertical-align: middle;background-color:#fff"><strong>CPF : </strong>' . $cpf_usuario . '</td>
            <td colspan="3" scope="colgroup" style="text-align: left;vertical-align: middle;background-color:#fff"><strong>RENAVAM : </strong>' . $renavam . '</td>
               
                
            </tr>
            <tr >
            <td  colspan="3" scope="colgroup" style="text-align: left;vertical-align: middle;background-color:#fff"><strong>PLACA : </strong>' . $placa . '</td>
            ...
            <tr >
            <td  colspan="3" scope="colgroup" style="text-align: left;vertical-align: middle;background-color:#fff"><strong>LOTAÇÃO : </strong>' . $lotacao . '</td>
            <td colspan="3" scope="colgroup" style="text-align: left;vertical-align: middle;background-color:#fff"><strong>ANO/MOD : </strong>' . $anomod . '</td>
            </tr>
            <tr >
            <td  colspan="6" scope="colgroup" style="text-align: left;vertical-align: middle;background-color:#fff"><strong>VISTORIADO EM : ' . $diavistoria . ' POR: ' . $empvistoria . '</strong></td>
            </tr>
